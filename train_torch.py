...
# Data loading params
train_file = "./prepro_train_10.txt"
valid_file = "./prepro_valid_10.txt"
test_file = "./prepro_test_10.txt"

# Model Hyperparameters
dim = 7    # dimensionality
ww = 7  # winodw width (6h)
up_time = 5.  # min
lw_time = 0.
up_dist = 10.   # km
lw_dist = 0.
...
user_cnt = 908 #50 #107092#0
loc_cnt = 99186 #50 #1280969#0
#user_cnt = 42242 #30
#loc_cnt = 1164559 #30
